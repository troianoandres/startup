describe("HomeTimelineController tests", function() {
  ...
  beforeEach(function() {
    ...
    controller = $controller("HomeTimelineController", {$scope: $scope});
  ...
  it("Expect all statemest to be correctly resolves", function() {
    ...
    expect(controller.tweetListConfig.title).toBe("Home timeline");
    expect(controller.tweetListConfig.source).toBe("home_timeline");
  });
